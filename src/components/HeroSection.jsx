...
const HeroSection = () => {
  return (
    <div
      id="home"
      className=" grow mt-3  mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 "
    >
      <div className=" grid grid-cols-1 lg:mt-4 xl:mt-0 lg:grid-cols-2 gap-3 md:gap-5 justify-stretch xl:py-32">
        <div className="justify-items-start mx-auto flex items-center ">
          <img
            className="w-44 h-44 mt-4 xl:mt-0 md:w-56 md:h-56 lg:w-80  lg:h-80 rounded-full lg:rounded-2xl transition duration-500 cursor-pointer ease-in-out hover:scale-105  border-4 hover:border-indigo-600"
            src={Heroimg}
            alt="Profile"
          />
        </div>
